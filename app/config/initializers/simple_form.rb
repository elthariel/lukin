...
SimpleForm.setup do |config|
  ...
  # in this configuration, which is recommended due to some quirks from different
  # browsers. To stop SimpleForm from generating the novalidate option, enabling
